...
public abstract class AbstractTerrain implements Terrain, Drawable, MoveBlocker, GameEntity {
	
	public static final int RENDERING_SIZE = 16;
	protected static DrawableImage image;
	int x, y;

	public AbstractTerrain(Canvas defaultCanvas, String gif, int xx, int yy) {
