 ...
 */
public class OctolinkIntersectTools {

	/**
	 * Hides the constructor
	 */
	private OctolinkIntersectTools() {
		super();
	}
	...
	public static Shape getIntersectShape(Movable movable,
		...
		int x1 = (int) movable.getPosition().getX() + (int) movable.getBoundingBox().getX();
		int y1 = (int) movable.getPosition().getY() + (int) movable.getBoundingBox().getY();
